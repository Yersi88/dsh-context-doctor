...
//#region ../../../../../../home/zhenyu/.dsh/source/staging-20260812T141217Z/vendor/cosmokit/lib/index.js
...
//#endregion
//#region ../../../../../../home/zhenyu/.dsh/source/staging-20260812T141217Z/vendor/schemastery/lib/index.mjs
...
//#endregion
//#region ../../../../../../home/zhenyu/.dsh/source/staging-20260812T141217Z/packages/core/scope/lib/index.js
/**
...
//#endregion
//#region ../../../../../../home/zhenyu/.dsh/source/staging-20260812T141217Z/packages/util/timeout/lib/index.js
/** Largest delay Node schedules without clamping it to one millisecond. */
const MAX_TIMER_DELAY_MS = 2147483647;
//#endregion
//#region ../../../../../../home/zhenyu/.dsh/source/staging-20260812T141217Z/packages/llm/llm/lib/index.js
/**
...
//#endregion
//#region ../../../../../../home/zhenyu/.dsh/source/staging-20260812T141217Z/packages/core/session/lib/index.js
...
//#endregion
//#region ../../../../../../home/zhenyu/.dsh/source/staging-20260812T141217Z/packages/core/tools/lib/index.js
/**
...
* @internal
*/
const TOOL_REGISTRY_SCHEDULER = Symbol("@deepseek-ai/dsh-tools.scheduler");
...
async function scanSkillCatalog(skills, cwd, signal) {
	...
	return {
		...
		duplicateDescriptions: list.map((s) => ({
			name: s.name,
...
async function runAudit(deps, options) {
	...
	if (options.includeSkillBodies === true) {
		...
		let count = 0;
		let totalTokens = 0;
		for (const summary of list.slice(0, max)) try {
	...
	const conflicts = findRankShadows((await skills.list({
		cwd,
		signal
	})).map((s) => ({
		name: s.name,
...
function makeAuditRoutes(config) {
	const { deps, defaultCwd, cacheTtlMs = 6e4 } = config;
	...
	return [{
		...
		handler: (req, res) => {
			...
			audit(parseCwd(req.url ?? "") ?? defaultCwd ?? process.cwd()).then((report) => json(res, 200, {
				ok: true,
				report
			}), (error) => json(res, 500, {
				ok: false,
